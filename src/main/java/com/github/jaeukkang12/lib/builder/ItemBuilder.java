...
import com.github.jaeukkang12.lib.Lib;
...
public class ItemBuilder {
    ...
    public ItemBuilder setNBT(String key, String value) {
        itemMeta.getPersistentDataContainer().set(new NamespacedKey(JavaPlugin.getProvidingPlugin(Lib.class), key), PersistentDataType.STRING, value);
        return this;
    }
    ...
    public ItemBuilder removeNBT(String key) {
        itemMeta.getPersistentDataContainer().remove(new NamespacedKey(JavaPlugin.getProvidingPlugin(Lib.class), key));
        return this;
    }
